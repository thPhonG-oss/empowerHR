...
//    ACCOUNT_NOT_EXITS("1011","user not exist", HttpStatus.BAD_REQUEST),
    ...
    EMPLOYEE_INACTIVE("1029", "EMPLOYEE_INACTIVE", HttpStatus.BAD_REQUEST),
    ACTIVITY_REGISTRATION_CLOSED("1030", "ACTIVITY_REGISTRATION_CLOSED", HttpStatus.BAD_REQUEST),
    ...
    MONTHLY_NOT_FOUND("1051","monthly not found",HttpStatus.BAD_REQUEST),
    NOT_EDIT_PAST_TIME("1052","Do not edit past time.",HttpStatus.BAD_REQUEST);
